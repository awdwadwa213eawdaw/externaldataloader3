...
assets.productId = {
	Starter = 1653513766,               --// 15 R$
	TenBP = 1653513779,                 --// 10 R$
	FiftyBP = 1653513798,               --// 30 R$
	TwoHundredBP = 1653513809,         --// 75 R$
	TwoThousandBP = 1653513822,        --// 200 R$
	UMV1 = 1653513834,                  --// 5 R$
	UMV3 = 1653513847,                  --// 10 R$
	UMV6 = 1653513854,                  --// 15 R$
	_10kP  = 1653513865,                --// 10 R$
	_50kP  = 1653513880,               --// 40 R$
	_100kP = 1653513895,                --// 75 R$
	_200kP = 1653513908,                --// 120 R$
	PBSpins1 = 1653513920,              --// 5 R$
	PBSpins5 = 1653513928,              --// 20 R$
	PBSpins10 = 1653513938,             --// 30 R$
	AshGreninja = 1653513948,           --// 75 R$
	Hoverboard = 1653513961,            --// 10 R$
	MasterBall = 1653513968,            --// 10 R$
	LottoTicket = 1653513978,            --// 30 R$
	TixPurchase = 1653513987,           --// 125 R$

	RouletteSpinBasic = 1653513998,     --// 15 R$
	RouletteSpinBronze = 1653514013,    --// 25 R$
	RouletteSpinSilver = 1653514025,    --// 60 R$
	RouletteSpinGold = 1653514042,      --// 85 R$
	RouletteSpinDiamond = 1653514055,   --// 125 R$
	RoPowers = {
		{1653514065, 1653514074},       --// 15 R$, 20 R$ (XP) 1-2
		{1653514087, 1653514100},       --// 10 R$, 15 R$ (Hatching) 3-4
		{1653514114, 1653514126},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{1653514136, 1653514154},       --// 10 R$, 15 R$ (EVs) 7-8
		{1653514169},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{1653514180}                    --// 45 R$ (Legendaries) 11
	},
}
assets.passId = {
	ExpShare = 1,
