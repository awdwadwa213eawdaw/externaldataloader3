return function(_p)
	...
	function SearchSystem:open(baseFramePC, onOpenFn)
		...
		Queries = {}
		totalClasses = 0
		local registeredSpecies, HeldItems, registeredAbilities, registeredMoves, registeredEggGroups, registeredFormes, registeredNicknames = _p.Connection:get("PDS", "cPC", "getSearchableLists")
		onOpenFn()
	...
	function SearchSystem:submit()
		...
		self.results = _p.Connection:get("PDS", "cPC", "search", self:getQuery())
